...
# Biome texture system - follows the player for perfect shader alignment
const BIOME_TEXTURE_SIZE: int = 256  # Pixels (256x256 texture)
...
func _setup_terrain_material() -> void:
	...
	if ResourceLoader.exists(shader_path):
		...
		mat.set_shader_parameter("biome_texture_size", BIOME_TEXTURE_WORLD_SIZE)
...
func _process(delta: float) -> void:
	...
	# Update chunks around players and biome texture
